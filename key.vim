...
" ------------nerdcommenter------------
nnoremap <silent> <F2> :call NERDComment(0,"toggle")<CR>
vnoremap <silent> <F2> :call NERDComment(0,"toggle")<CR>
nmap <F4> :IndentGuidesToggle<cr>
nmap <F3> :PymodeLintAuto<cr>
"------------vim-autoformat----------
...
nnoremap <space>g :YcmCompleter GoToDefinition<cr>
map <space>y :let g:ycm_auto_trigger=0<CR>
