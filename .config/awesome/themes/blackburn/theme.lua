...
theme.wallpaper                                 = "/home/wolf/.config/awesome/themes/blackburn/wall.png"
theme.font                                      = "Poiret One Bold 12"
theme.taglist_font                              = "FontAwesome 10"
theme.fg_normal                                 = "#00CCFF"
theme.fg_focus                                  = "#00CCFF"
theme.bg_normal                                 = "#06060664"
theme.bg_focus                                  = "#06060664"
theme.fg_urgent                                 = "#00CCFF64"
theme.bg_urgent                                 = "#2A1F1E64"
theme.border_width                              = 0
theme.border_normal                             = "#0E0E0E64"
theme.border_focus                              = "#F7937264"
theme.taglist_fg_normal                         = "#00CCFF64"
theme.taglist_fg_focus                          = "#00CCFF"
theme.taglist_bg_focus                          = "#DFDFDF64"
theme.tasklist_fg_focus                         = "#F6784F64"
theme.tasklist_bg_focus                         = "#06060664"
...
theme.layout_fairv                              = theme.dir .. "/icons/fairv1.png"
theme.layout_fairh                              = theme.dir .. "/icons/fairh1.png"
theme.layout_spiral                             = theme.dir .. "/icons/spiral1.png"
theme.layout_dwindle                            = theme.dir .. "/icons/dwindle1.png"
theme.layout_max                                = theme.dir .. "/icons/max1.png"
theme.layout_fullscreen                         = theme.dir .. "/icons/fullscreen1.png"
theme.layout_magnifier                          = theme.dir .. "/icons/magnifier1.png"
...
theme.fs = lain.widget.fs({
    options  = "--exclude-type=tmpfs",
    notification_preset = { fg = gray, bg = theme.bg_normal, font = "Poiret One Bold 10" },
    settings = function()
...
theme.weather = lain.widget.weather({
    city_id = 1591449, -- placeholder (London)
    settings = function()
...
--local arrl_post = separators.arrow_right("alpha") --("#1A1A1A", "alpha")
...
local barcolor  = gears.color({
    ...
    stops = { {0, theme.bg_focus }, {0.8, theme.border_normal}, {0.9, "#1A1A1A64"} }
})
...
theme.titlebar_bg_focus = gears.color({
    ...
    from  = { barheight, 0 },
    to    = { barheight, barheight },
    stops = { {0, theme.bg_normal}, {0.5, theme.border_normal}, {0.9, "#49241764"} }
